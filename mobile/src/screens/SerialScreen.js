...
export default function SerialScreen({ navigation }) {
  ...
  const PRIMARY_COLOR = '#9B59B6'; // Soft Purple for Privacy module
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Remove sensitive information from your photos</Text>
        </View>
      </View>
          ...
          {!selectedImage && (
            <View style={styles.uploadFrame}>
              <View style={styles.uploadContent}>
                ...
                <Text style={styles.uploadSubtext}>Automatically detects and blurs serial numbers, model names, and sensitive data</Text>
            ...
            <TouchableOpacity style={[styles.processButton, { backgroundColor: loading ? '#CCC' : PRIMARY_COLOR }]} onPress={processImage} disabled={loading}>
              <View style={styles.processButtonContent}>
                {loading ? (
                  ...
                  <Text style={styles.processButtonText}>🔒 Remove Sensitive Data</Text>
                )}
              </View>
            </TouchableOpacity>
          )}
          ...
          {processedImage && (
            <View style={styles.resultSection}>
              <View style={styles.resultHeader}>
                <Text style={styles.resultTitle}>✅ Privacy Protected</Text>
              </View>
              <View style={styles.imageFrame}>
